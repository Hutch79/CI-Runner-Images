...
# Build script for .NET 8 demo application
# This script builds the application located in ./data

set -e  # Exit on any error

echo "Building .NET 8 demo application..."
...
dotnet publish ./src/DotNet-8.Demo/DotNet-8.Demo.csproj --configuration Release --output ./publish --no-build

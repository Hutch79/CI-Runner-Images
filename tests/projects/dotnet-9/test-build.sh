...
# Build script for .NET 9 demo application
# This script builds the application located in ./data

set -e  # Exit on any error

echo "Building .NET 9 demo application..."
...
dotnet publish ./src/DotNet-9.Demo/DotNet-9.Demo.csproj --configuration Release --output ./publish --no-build
